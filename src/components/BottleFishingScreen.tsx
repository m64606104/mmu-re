...
export default function BottleFishingScreen({ onBack, userName }: BottleFishingScreenProps) {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50 flex flex-col">
      {/* 顶部栏 */}
      <div className="bg-white/80 backdrop-blur-sm border-b border-blue-200 px-4 py-4 flex items-center gap-3 shrink-0">
      ...
      <div className="flex-1 overflow-y-auto p-4" style={{ minHeight: 0 }}>
        <div className="max-w-2xl mx-auto">
          {/* 海洋背景区域 */}
          <div className="relative bg-gradient-to-b from-blue-400 to-blue-600 rounded-3xl p-8 mb-4 overflow-hidden min-h-[400px] flex items-center justify-center">
            {/* 波浪装饰 */}
